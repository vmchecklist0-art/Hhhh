        ...
        <div className="w-full max-w-3xl mx-auto text-center space-y-6 sm:space-y-8">
          ...
          >
            <Button
              onClick={handleEnter}
              variant="outline"
              className="landing-cta group relative inline-flex items-center gap-2 border-border/90 bg-card/85 text-foreground hover:bg-card hover:border-ring/60 shadow-sm"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mt-10 sm:mt-14">
            {FEATURES.map(({ icon: Icon, title, description, color }, index) => (
              ...
              >
                <Card className="group relative cursor-default gap-0 rounded-2xl border-border/70 bg-card/70 py-4 sm:py-5 hover:scale-[1.03] hover:bg-card/95 hover:shadow-md transition-all duration-300 h-full">
